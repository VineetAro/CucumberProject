...
public class OrangeHrm {
	...
	public void fill_out_the_necessary_details() {
		...
		driver.manage().timeouts().implicitlyWait(10,TimeUnit.SECONDS);
		driver.findElement(By.id("addJobVacancy_name")).sendKeys("SFDC_Einstein_12345");
	...
	public void verify_the_vacancy() {
		...
		for(WebElement vacancy : vacancies) {
			if ((vacancy.getText()).equals("SFDC_Einstein_12345")) {
	...
	public void on_next_page_fill_in_the_details_of_the_candidate() {
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("Test32FName");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("Test32LName");
		driver.findElement(By.id("addCandidate_email")).sendKeys("Test32FName2LName@ibm.com");
		
		Select vApply = new Select(driver.findElement(By.id("addCandidate_vacancy")));
		vApply.selectByVisibleText("SFDC_Einstein_12345");
	...
	public void upload_a_resume_to_the_form() {
		...
		addFile.sendKeys("C:/Users/VineetArora/Desktop/Resume.docx");
	}
